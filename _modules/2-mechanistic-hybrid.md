...
: **Lecture 5**{: .label .label-purple }
  ...
  * Hybrid modeling spectrum: neural ODEs / universal differential equations / gray-box modeling
...
Apr 15
: **Lecture 6**{: .label .label-purple } : **Student-led paper presentations**{: .label .label-blue }
...
: **Lecture 7**{: .label .label-purple }
  ...
  * Virtual cell models / digital twins: objective and scope
...
Apr 22
: **Lecture 8**{: .label .label-purple } : **Guest lecture**{: .label .label-green }
