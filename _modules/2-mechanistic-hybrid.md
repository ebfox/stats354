...
{: .schedule }
Apr 13
: **Lecture 5**{: .label .label-purple } **Inductive bias taxonomy through case studies**
...
* **Student presentation**{: .label .label-blue } inductive bias in biomedical ML (e.g., equivariance in molecular models, graph-structured priors, or evaluation-as-bias)

Apr 15
: **Lecture 6**{: .label .label-purple } **The hybrid modeling toolkit**
...
* **Student presentation**{: .label .label-blue } hybrid modeling (e.g., neural ODE for clinical trajectories, PK/PD, mechanistic pathway integration, or gray-box approaches in biological systems)
