...
{: .schedule }
Apr 20
: **Lecture 7**{: .label .label-purple } **From pixels and counts to causal state**
...
* **Student presentation**{: .label .label-blue } hybrid or mechanistic modeling (e.g., structured dynamics, physics-informed approaches to clinical data, or domain-knowledge-constrained learning)
...
{: .schedule }
Apr 27
: **Lecture 9**{: .label .label-purple } **Perturbation biology, multimodal representations, and interpretability**
...
* **Student presentation**{: .label .label-blue } perturbation biology (e.g., response prediction, counterfactual inference, or benchmarking)
...
{: .schedule }
May 4
: **Lecture 11**{: .label .label-purple } : **Guest lecture**{: .label .label-green } **CellFlux — flow matching for perturbation** prediction
...
* **Student presentation**{: .label .label-blue } generative modeling or flow matching for biological data
