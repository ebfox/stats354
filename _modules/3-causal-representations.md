...
: **Lecture 9**{: .label .label-purple }
  ...
  * Causal representation learning: from pixels/counts to causal state
  * Invariance across environments; identifiability requirements (and why they often fail)
  * Representations as hypotheses tested by interventional and OOD probes
...
: **Lecture 11**{: .label .label-purple }
  ...
  * Causal graph discovery with interventions; interference; multimodal learning from unpaired data
